      ...
      <div class="row m-0">
        <div class="col-12 p-0">    
          <div class="login-card login-dark">
            <div>
              <div><a class="logo" href="{{ route('admin.login') }}"> <img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/logo-icon-1.webp') }}" alt="" style="max-width: 50% !important;"><img class="img-fluid for-light" src="{{ asset('admin/assets/images/logo/logo-icon-1.webp') }}" alt="looginpage" style="max-width: 50% !important;"></a></div>
