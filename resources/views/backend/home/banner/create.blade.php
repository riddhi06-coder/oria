        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Banner & Intro Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Banner & Intro Details</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-banner-intro.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
