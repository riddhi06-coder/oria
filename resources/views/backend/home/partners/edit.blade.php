                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-our-partners.update', $feature->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section_title" type="text" name="section_title"
                                                value="{{ old('section_title', $feature->section_title) }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($feature->banner_image)
                                                <div class="mt-2">
                                                    <img src="{{ asset('uploads/home/' . $feature->banner_image) }}" alt="Current Banner" 
                                            ...
                                            <div class="mt-2">
                                                <img id="banner_preview" src="#" alt="Banner Preview" 
                                                    style="display:none; max-height:150px; border:1px solid #ddd; padding:5px; border-radius:5px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <textarea class="form-control" id="editor" name="section_description" rows="4" 
                                                    placeholder="Enter Section Description" required>{{ old('section_description', $feature->section_description) }}</textarea>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div id="gallery-preview-container-{{ $index }}">
                                                                        <img src="{{ asset('uploads/home/' . $gallery) }}" 
                                                                            alt="Gallery Image" 
                                                                            style="max-height:100px; margin:5px; padding:5px; border:1px solid #ccc;">
                                                                    </div>
                                                                     <input type="hidden" name="existing_gallery_images[]" value="{{ $gallery }}">
                                                                </td>
                                                                <td>
                                                                    @if($index == 0)
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#addGalleryRow').click(function () {
                const rowId = $('#galleryTable tbody tr').length; // count existing rows
