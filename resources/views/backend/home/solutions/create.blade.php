                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-our-solutions.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="solution_type" name="solution_type" required>
                                                ...
                                                @foreach($solutionTypes as $solution)
                                                    <option value="{{ $solution->id }}">{{ $solution->solution_type }}</option>
                                                @endforeach
                                            </select>
