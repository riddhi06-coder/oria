        ...
        <div class="row">
          <div class="col-12">     
            <div class="login-card login-dark">
              <div>
              <div><a class="logo" href="#"><img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/logo-icon-1.webp') }}" alt="looginpage" style="max-width: 50% !important;"><img class="img-fluid for-light" src="{{ asset('admin/assets/images/logo/logo-icon-1.webp') }}" alt="looginpage" style="max-width: 50% !important;"></a></div>
