        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Solutions Type Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Solutions Type Details</li>
                </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h4>Solutions Type Details Form</h4>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-solution-type.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                       ...
                                       <!-- Banner Image-->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="solution_type" type="text" name="solution_type" placeholder="Enter Solutions Type" required>
